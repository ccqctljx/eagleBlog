...
<div id="wrapper">
    <nav class="navbar navbar-default top-navbar" role="navigation">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.jsp"><strong><i class="icon fa fa-gears"></i> 管理中心</strong></a>
    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a class="active-menu" href="index.jsp"><i class="fa fa-dashboard"></i> 仪表板</a>
                </li>
                <li>
    ...
    <div id="page-wrapper">
        <div class="header">
            <h1 class="page-header">
                报表
                <small>欢迎，${fns:getUser().nickName}</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#">主页</a></li>
                <li><a href="#">仪表板</a></li>
